...
- Create: `muse-vtuber/CLAUDE.md`

The repo lives at `muse-vtuber/` inside the zyphraexps project root (already in zyphraexps `.gitignore`).
...
- [ ] **Step 6: Init git repo and install**
